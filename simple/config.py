...
SIMPLE_ROOT   = os.path.join(PROJECT_ROOT, "simple")
RAW_CSV       = os.path.join(SIMPLE_ROOT, "data", "dataset.csv")
RESULTS_DIR   = os.path.join(SIMPLE_ROOT, "results")
RUNS_DIR      = os.path.join(RESULTS_DIR, "runs")
LEADERBOARD   = os.path.join(RESULTS_DIR, "leaderboard.csv")
XAI_DIR       = os.path.join(SIMPLE_ROOT, "xai_visuals")
