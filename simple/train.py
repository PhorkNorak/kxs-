...
from simple.evaluate import metrics
...
def train_classical(model_id, preprocess_mode, input_fmt, train_df, val_df, test_df, run_id):
    from simple.data import apply_preprocess, build_text_lists
    from simple.models.classical import make_classical
...
def train_bilstm(preprocess_mode, input_fmt, train_df, val_df, test_df, run_id, max_epochs=None):
    from simple.data import apply_preprocess, build_pair, CharPairDataset, build_char_vocab
    from simple.models.bilstm import BiLSTMScorer
...
def train_transformer(
    ...
    from simple.data import apply_preprocess, PairDataset, CrossDataset
